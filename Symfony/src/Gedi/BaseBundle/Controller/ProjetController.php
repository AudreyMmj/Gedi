...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $projets = $em->getRepository('GediBaseBundle:Projet')->findAll();
    ...
    {
        $projet = new Projet();
        $form = $this->createForm('Gedi\BaseBundle\Form\ProjetType', $projet);
    ...
    {
        $deleteForm = $this->createDeleteForm($projet);
        $editForm = $this->createForm('Gedi\BaseBundle\Form\ProjetType', $projet);
