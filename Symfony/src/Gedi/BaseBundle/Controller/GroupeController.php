...
class GroupeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groupes = $em->getRepository('GediBaseBundle:Groupe')->findAll();
    ...
    {
        $groupe = new Groupe();
        $form = $this->createForm('Gedi\BaseBundle\Form\GroupeType', $groupe);
    ...
    {
        $deleteForm = $this->createDeleteForm($groupe);
        $editForm = $this->createForm('Gedi\BaseBundle\Form\GroupeType', $groupe);
