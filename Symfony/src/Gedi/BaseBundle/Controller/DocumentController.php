...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $documents = $em->getRepository('GediBaseBundle:Document')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Gedi\BaseBundle\Form\DocumentType', $document);
    ...
    {
        $deleteForm = $this->createDeleteForm($document);
        $editForm = $this->createForm('Gedi\BaseBundle\Form\DocumentType', $document);
